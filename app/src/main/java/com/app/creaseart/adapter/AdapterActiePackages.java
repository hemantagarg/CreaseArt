 ...
 */
public class AdapterActiePackages extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterActiePackages(Context context, OnCustomItemClicListener lis, ArrayList<ModelPackage> list) {
